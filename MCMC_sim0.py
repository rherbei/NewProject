###################################
##Simulate s=0, use "correct" prior
###################################
...
np.savetxt('Chains/MCMC_sim0_ss4.txt',allss)
#np.savetxt('Chains/MCMC_sim0_qs4.txt',allqs)

#save rejection counts
np.savetxt('Output/MCMC_sim0_rejS4.txt',rejs)
np.savetxt('Output/MCMC_sim0_rejQ4.txt',rejq)