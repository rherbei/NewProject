#####################################
##Simulate s=5.5, use "correct" prior
#####################################
...
np.savetxt('Chains/MCMC_sim55_ss4.txt',allss)
#np.savetxt('Chains/MCMC_sim55_qs4.txt',allqs)

#save rejection counts
np.savetxt('Output/MCMC_sim55_rejS4.txt',rejs)
np.savetxt('Output/MCMC_sim55_rejQ4.txt',rejq)