##################################
##Simulate s=11, use Uniform prior
##################################
...
np.savetxt('Chains/MCMC_sim11_unif_ss4.txt',allss)
#np.savetxt('Chains/MCMC_sim11_unif_qs4.txt',allqs)

#save rejection counts
np.savetxt('Output/MCMC_sim11_unif_rejS4.txt',rejs)
np.savetxt('Output/MCMC_sim11_unif_rejQ4.txt',rejq)
